...
const FeaturesSection = () => {
  const features = [
    ...
    },
    {
      ...
      description: 'Engage with hands-on projects and real-world applications in every course.'
    },
    {
      icon: (
        <svg className="h-12 w-12 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: 'Choose from a variety of pricing options to fit your budget and learning needs.'
    },
    {
      icon: (
        <svg className="h-12 w-12 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
